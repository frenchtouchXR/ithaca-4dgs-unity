...
namespace GaussianSplatting4D.Runtime
{
    public class GaussianSplatAsset : ScriptableObject
    {
        ...
        public void SetAssetFiles(TextAsset dataChunk, TextAsset dataPos, TextAsset dataOther, TextAsset dataColor, TextAsset dataSh, TextAsset dataTemporal = null)
        {
        ...
        [SerializeField] TextAsset m_TemporalData;
        ...
        public TextAsset temporalData => m_TemporalData;
